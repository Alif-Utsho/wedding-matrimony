                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="email"
                                                placeholder="Branding email" value="{{ $contactinfo->email }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="phone"
                                                placeholder="Branding phone" value="{{ $contactinfo->phone }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="address"
                                                placeholder="Branding address" value="{{ $contactinfo->address }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="whatsapp"
                                                placeholder="Branding whatsapp" value="{{ $contactinfo->whatsapp }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
