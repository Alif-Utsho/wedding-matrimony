...
@section('content')
    <div class="pan-rhs">
        ...
        <div class="box-com box-qui box-lig box-tab box-form">
            <div class="tit">
                <h3>Sub Package Create</h3>
                <div class="dropdown">
                    <button type="button" class="btn btn-outline-secondary" data-bs-toggle="dropdown">
                        <i class="fa fa-ellipsis-h" aria-hidden="true"></i>
                    </button>
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="{{ route('admin.subpackage.manage') }}">Manage sub package
                                posts</a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="form-inp mt-2">
                <form action="{{ route('admin.subpackage.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <!--PROFILE BIO-->
