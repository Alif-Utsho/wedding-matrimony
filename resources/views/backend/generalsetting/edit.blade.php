    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box-com box-qui box-lig box-form">
                <div class="form-inp">
                    <form action="{{ route('admin.generalsetting.update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-5">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name" placeholder="Branding name" value="{{ $generalsetting->name }}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    ...
                                    <div class="fil-img-uplo">
                                        ...
                                        <input type="file" name="logo" accept="image/*,.jpg,.jpeg,.png" id="fileInput">
                                    </div>
                                    <div>
                                        <img src="{{ asset($generalsetting->logo) }}" alt="" class="backend-img">
                                    </div>
                                </div>
                                <div class="col-md-6 form-group">
                                    ...
                                    <div class="fil-img-uplo">
                                        <span class="dumfil">Upload image</span>
                                        <input type="file" name="favicon" accept="image/*,.jpg,.jpeg,.png" id="fileInput">
                                    </div>
                                    <div>
                                        <img src="{{ asset($generalsetting->favicon) }}" alt="" class="backend-img float-end">
                                    </div>
                                </div>
                            </div>
                        </div>
