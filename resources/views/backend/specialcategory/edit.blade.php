...
@section('content')
    <div class="pan-rhs">
        <div class="row main-head">
            <div class="col-md-6">
                <div class="tit">
                    <h1>Special Sub Package Edit</h1>
                </div>
            </div>
            <div class="col-md-6">
        ...
        <div class="box-com box-qui box-lig box-tab box-form">
            <div class="tit">
                <h3>Special Sub Package Edit</h3>
                <div class="dropdown">
                    <button type="button" class="btn btn-outline-secondary" data-bs-toggle="dropdown">
                        <i class="fa fa-ellipsis-h" aria-hidden="true"></i>
                    </button>
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="{{ route('admin.specialcategory.manage') }}">Manage Special
                                Package</a>
                        </li>
            ...
            <div class="form-inp mt-2">
                <form action="{{ route('admin.specialcategory.update') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <!--PROFILE BIO-->
                            ...
                            <select class="form-select chosen-select" data-placeholder="Select Package" name="special_id"
                                ...
                                @foreach ($categories as $category)
                                    <option value="{{ $category->id }}"
                                        {{ $category->id == $specialPackage->special_id ? 'selected' : '' }}>
