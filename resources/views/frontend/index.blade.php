...
<body>
    ...
    <div class="menu-pop menu-pop1">
        ...
        <div class="inn">
            <img src="images/bibaaha.png" alt="" loading="lazy" class="logo-brand-only">
            ...
            <ul class="menu-pop-info">
                ...
                <li><a href="#!"><i class="fa fa-envelope-o" aria-hidden="true"></i>messageappsis@gmail.com </a></li>
                <li><a href="#!"><i class="fa fa-map-marker" aria-hidden="true"></i>SIS Media, Level # 9, Suite # 10-A, Razzak Plaza, 383 Boro Moghbazar, Dhaka, Bangladesh</a></li>
            </ul>
            ...
            <div class="row">
                <div class="hom-nav">
                    ...
                    <div class="logo">
                        ...
                        <a href="index.html" class="logo-brand"><img src="images/logoo.png" alt="" loading="lazy"
                                class="ic-logo"></a>
                    </div>
...
<!-- Mirrored from rn53themes.net/themes/matrimo/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Sep 2024 10:55:22 GMT -->
</html>